...
/**
 * @magentoComponentsDir Magento/Setup/Console/Console/_files/root/app/code
 */
class I18nPackCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute()
    {
        $this->tester->execute(
            [
                'source' => BP . '/dev/tests/integration/testsuite/Magento/Setup/Console/Console/_files/i18n.csv',
                'locale' => 'de_DE',
        ...
        $basePath = BP . '/dev/tests/integration/testsuite/Magento/Setup/Console/Console/_files/root/app/code';
    ...
    public function testExecuteNonExistingPath()
    {
        ...
        $nonExistPath = BP . '/dev/tests/integration/testsuite/Magento/Setup/Console/Console/_files/non_exist.csv';
        $this->tester->execute(
            [
                'source' => $nonExistPath,
                'locale' => 'de_DE',
